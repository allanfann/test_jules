...
class _DecisionScreenState extends State<DecisionScreen> {
  ...
  final String _treeId = "sample_tree";
  ...
  Future<void> _fetchDecision(DecisionRequest request) async {
    ...
    setState(() {
      _question = "Loading...";
      _answers = [];
      _isOutcome = true; // To hide buttons while loading
    });
    ...
    try {
      ...
      setState(() {
        _question = "Failed to load decision. Check backend URL in settings.";
        _answers = [];
        _isOutcome = true;
      });
    }
  ...
  void _navigateToSettings() {
    Navigator.of(context).push(
      ...
      // When returning from settings, restart the tree traversal
      // to use the potentially new URL.
      _startFresh();
    });
  }
